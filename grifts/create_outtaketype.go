...
var canonicalOuttakeTypes = []struct {
	...
	{"OT6", "Adoption", "Animal placé en captivité autorisée car espèce non indigène.", false, false, false, nulls.NewInt(0), "NS1,NS3", models.OuttakeLocationModeList},
	// OT7 carries no rating (#199-11): a duplicate file is an administrative
	// error, not a Positive/Negative/Neutral outcome.
	{"OT7", "Doublon", "Fiche créée en double pour le même animal.", false, false, true, nulls.Int{}, "", models.OuttakeLocationModeNone},
}
