...
) ENGINE=InnoDB AUTO_INCREMENT=997881 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `attachment_blobs`
--
...
--
-- Table structure for table `care_templates`
--

DROP TABLE IF EXISTS `care_templates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `care_templates` (
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `care_templates_user_id_idx` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `outtake_location_options`
--

DROP TABLE IF EXISTS `outtake_location_options`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `outtake_location_options` (
  `id` char(36) NOT NULL,
  `name` varchar(255) NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
...
-- Dump completed on 2026-09-21 15:27:36
